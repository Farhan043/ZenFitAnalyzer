// // This file contains all the meal data
// // You can easily add more meals by following the same structure
...
//         "mealType": "Lunch",
//         "vegNonVeg": "Veg",
//         "dishName": "Vegetable Rasam Rice",
//         "calories": 220,
//         "protein": 8,
//         "carbs": 40,
//         "fat": 4,
//         "description": "A light, spiced soup with rice using minimal salt.",
//         "ingredients": ["Tomatoes", "Tamarind", "Pepper", "Cumin"],
//         "steps": ["Prepare rasam", "Cook rice", "Combine and temper", "Serve hot"]
//       },
//       {
//         "mealType": "Dinner",
//         "vegNonVeg": "Veg",
...
//     } else if (field === 'dietaryCondition') {
//       values.add(region.dietaryCondition);
//     } else if (field === 'mealType' || field === 'vegNonVeg') {
//       region.meals.forEach(meal => {
//         values.add(meal[field]);
//       });
//     }
//   });
