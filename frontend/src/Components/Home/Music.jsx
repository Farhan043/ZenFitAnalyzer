...
//   return (
//     <>
//       <div className=' text-white  min-h-sceen'>
//       <div className="mockup-phone border-primary max-w-screen w-full">
...
//           <img src="/public/spotify.gif" alt="" className='w-32 h-28' />
//           <p className='text-lg mb-6 text-gray-100'>Discover and enjoy your favorite tunes</p>
//           <button 
//             className='text-xl text-white rounded-lg bg-slate-900  px-6 py-3' 
