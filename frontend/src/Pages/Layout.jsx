...
export default function Layout() {
  return (
    <div className="bg-gray-100 mt-5 min-h-screen flex flex-col items-center p-6">
      {/* Header Section */}
      ...
      {/* Features Section */}
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-4xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
...
function FeatureCard({ icon, title, description }) {
  return (
    <div className="flex flex-col items-center bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-xl transition duration-300">
      {icon}
