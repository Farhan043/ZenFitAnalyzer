      ...
      <div className="w-96 p-6">
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-white font-bold underline mt-3 text-lg mb-2">Lean & Tone</h2>
            <p className="text-center text-white mt-8  text-base">
              I’m <span className='text-black text-2xl'>“skinny fat”.</span>  look thin but have no shape. I want to add learn muscle in the right way
            </p>
          </div>
        </div>
