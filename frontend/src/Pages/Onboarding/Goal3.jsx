      ...
      <div className="w-96 p-6">
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-white font-bold underline mt-3 text-lg mb-2">Lose a Fat</h2>
            <p className="text-center text-white mt-8  text-base">
              I have over <span className='text-black text-2xl font-bold'> 20 lbs to lose.</span> I want to drop all this fat and gain muscle mass
            </p>
          </div>
        </div>
