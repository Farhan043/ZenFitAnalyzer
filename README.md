...
- `gender` (string): The gender of the user. Must be one of 'male', 'female', or 'other'.
- `dob` (date): The date of birth of the user.
- `weight` (number): The weight of the user in kilograms.
- `height` (number): The height of the user in centimeters.
...
password
 ...
 (string): The password of the user. Must be at least 6 characters long.
